from Modules.Utils import get_key_by_value
from Readers import ExcelReader
from Modules import SyllableFinder, ExcelGenerator, CsvGenerator
import collections
import os
...
my_excel_reader_dict = ExcelReader.ExcelReader(input_path)
my_excel_reader = ExcelReader.ExcelReader("Syllables.xlsx")
...
my_excel_writer = ExcelGenerator.ExcelGenerator(os.path.join(output_path, "NEW Words Contain Syllables.xls"), ordered_mapping, original_wordform_mapping, syllable_key_mapping, biphone_mapping)
my_csv_writer = CsvGenerator.CsvGenerator(os.path.join(output_path, "NEW Words Contain Syllables.csv"), ordered_mapping, original_wordform_mapping, syllable_key_mapping, biphone_mapping)